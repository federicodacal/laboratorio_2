        ...
        private void FrmPrincipal_Load(object sender, EventArgs e)
        {
            ...
            foreach (Aplicacion app in listaApps)
            {
                ...
                if (!Dispositivo.InstalarApp(app))
                {
                    ...
                    this.rtbAppsNoInstaladas.Text += string.Concat(app.ToString(), "\n");
                }
                ...
                Aplicacion appMasPesada = Dispositivo.AppsInstaladas;
                this.rtbAppsInstaladas.Text += "App mayor tamaño\n" + appMasPesada.ObtenerInformacionApp();
            }
        }
    }
}
