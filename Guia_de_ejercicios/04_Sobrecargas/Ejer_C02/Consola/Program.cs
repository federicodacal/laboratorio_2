...
namespace Consola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Estante estante2 = new Estante(2, 5);
            ...
            Producto p5 = new Producto("Coca-Cola", "COSDS55752", (float)12.5);

            Console.WriteLine(p2==p5);
            Console.WriteLine(p2!=p5);
            Console.WriteLine(p1==p5);
            Console.WriteLine();
            Console.WriteLine(p1=="Fanta");
            Console.WriteLine(p2!="Coca-Cola");
            Console.WriteLine(p4=="Crush");
            Console.WriteLine();
            Console.WriteLine("-------------------------------------------------");
            Console.WriteLine();
