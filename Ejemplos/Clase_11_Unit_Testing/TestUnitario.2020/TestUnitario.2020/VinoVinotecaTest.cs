...
namespace TestUnitario._2020
{
    ...
    {
        [TestMethod]
        public void VerificarIgualdadVinos_True()
        {
            //Arrange
        ...
        [TestMethod]
        public void VerificarIgualdadVinos_False()
        {
            //Arrange
            Vino v1 = new Vino(ETipoVino.Merlot, EBodega.Zuccardi);
        ...
        [TestMethod]
        public void VinotecaDefaultArrayDeVinosCapacidadTres()
        {
            //Arrange
            ...
            //Assert
            Assert.AreEqual(expectedLength, vinos.Length);
        }
