...
namespace Delegados.Consola
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Se creo una instancia del delegado 'DelegadoDeMiFuncion' " +
            ...
            //OBTENGO LA INSTANCIA QUE CONTIENE EL METODO DEL DELEGADO MEDIANTE PROPIEDAD 'TARGET' (INDICA DONDE SE ENCUENTRA LA INSTANCIA QUE CONTIENE EL METODO DENTRO DE MI DELEGADO) 
            ...
            // Duplica la lista de delegados no importa si esta repetida
