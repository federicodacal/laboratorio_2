...
namespace _02
{
    class Program
    {
        ...
        private static void Funcion1()
        {
            ...
            Console.WriteLine("Finaliza la función 1");
        }
        private static void Funcion2()
        {
            ...
            Console.WriteLine("Finaliza la función 2");
        }
        ...
        private static void Funcion3()
        {
            ...
            Console.WriteLine("Finaliza la función 3");
        }
        ...
        private static void Funcion4()
        {
            ...
            Console.WriteLine("Finaliza la función 4");
        }
        ...
        private static void Funcion5()
        {
            ...
            Console.WriteLine("Finaliza la función 5 - Numero: {0}", i);
        }
    }
}
