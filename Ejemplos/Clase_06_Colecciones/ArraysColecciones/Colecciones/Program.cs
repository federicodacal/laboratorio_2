...
namespace Colecciones
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Program.MostrarGenericsVsNoGenerics();
        }
        ...
        public static void MostrarColeccionesNoGenerics()
        {
            ...
            Console.WriteLine("Utilizo cola.Enqueue()");
            Console.WriteLine("Orden de los elementos: 1 - 2 - 3 - 4");
            Console.ReadLine();
            ...
            Console.Clear();
            Console.WriteLine("*********************************************");
            Console.WriteLine("******Listas Dinámicas - No Genéricas********");
            Console.WriteLine("*********************************************");
            Console.ReadLine();
            ...
            Console.Clear();
            Console.WriteLine("***********************************************");
            Console.WriteLine("*********Tablas Hash - No Genéricas************");
            Console.WriteLine("***********************************************");
            Console.ReadLine();
        ...
        public static void MostrarColeccionesGenerics()
        {
            ...
            Console.WriteLine("******************************************");
            Console.WriteLine("*********Diccionario - Genérico***********");
            Console.WriteLine("******************************************");
            Console.ReadLine();
        ...
        public static void MostrarGenericsVsNoGenerics()
        {
            ...
            foreach (Object item in pilaNoGenerica)
            {
                if(item is Persona)
                {
                    Console.WriteLine(((Persona)item).MostrarPersona());
                }
            ...
            Stack<Persona> pilaGenerica;

            //INSTANCIO LA PILA GENERICA DE TIPO PERSONA
            pilaGenerica = new Stack<Persona>();
